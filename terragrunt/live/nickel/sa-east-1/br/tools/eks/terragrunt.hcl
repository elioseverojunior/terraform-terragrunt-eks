...
inputs = {
  ...
  aws = {
    "region" = include.root.locals.inputs.aws_region
  }
  ...
  cluster_addons = {
    ...
    kube-proxy = {
      addon_version     = "v1.22.2-eksbuild.2"
      resolve_conflicts = "OVERWRITE"
    }
    vpc-cni = {
  ...
  eks_managed_node_groups = {
    ...
    "${include.root.locals.inputs.application}-a" = {
      desired_size            = 1
      ami_type                = "AL2_x86_64"
      platform                = "linux"
    ...
    "${include.root.locals.inputs.application}-b" = {
    ...
    "${include.root.locals.inputs.application}-c" = {
      ami_type                   = "BOTTLEROCKET_x86_64"
      platform                   = "bottlerocket"
      instance_types             = ["t3a.large"]
